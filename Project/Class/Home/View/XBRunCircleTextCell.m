...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.contentView.mj_h = XBRunCircleTextCellHeigtHt;
        self.mj_h = XBRunCircleTextCellHeigtHt;
        ...
        UIImageView *iconImg = [[UIImageView alloc]initWithFrame: CGRectMake(5, 5, self.mj_h - 10, self.mj_h - 10)];
        iconImg.image = [UIImage imageNamed:@"Lotteryhallmessage"];
