...
- (void)viewDidLoad {
    ...
    [self.navigationController.navigationBar setBarTintColor:RGBColor(235, 49, 58)];
...
#ifndef INCLUDE_MEIQIA_SDK
    UIBarButtonItem *loadMessageButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"完成" style:(UIBarButtonItemStylePlain) target:self action:@selector(tapNavigationRightBtn:)];
